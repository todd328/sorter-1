...
Standalone Windows build of the OPEX Sorter 1 barcode routing service.
...
3. Under **Artifacts**, download `SorterOne-windows`.
4. Unzip it — you'll get `SorterOne.exe`, ready to run on Windows (no Python install required).
